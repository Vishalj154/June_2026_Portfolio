      ...
      <header className={`navbar ${scrolled ? 'scrolled' : ''}`}>
        <div className="nav-inner">
          ...
          <div className="nav-actions">
            <a href="/Vishal_Jankar_Resume.pdf" download className="btn btn-primary nav-resume-btn">
      ...
      <AnimatePresence>
        {open && (
          <motion.div className="mobile-menu" initial={{opacity:0,y:-10}} animate={{opacity:1,y:0}} exit={{opacity:0,y:-10}}>
            ...
            <a href="/Vishal_Jankar_Resume.pdf" download className="btn btn-primary" style={{width:'100%',marginTop:'0.25rem'}}><Download size={15}/>Download Resume</a>
          </motion.div>
        )}
      </AnimatePresence>
    </>
